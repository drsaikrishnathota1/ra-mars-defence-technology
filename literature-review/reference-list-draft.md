# RA-MARS Reference List Draft

## Purpose

This file contains the working numbered reference list for the RA-MARS manuscript. The references are based on the verified literature matrix and should be checked again before final journal submission.

## Important Notes

- Final references must be formatted according to Defence Technology / Elsevier requirements.
- DOI values should be verified before submission.
- Duplicate references should be removed.
- In-text citations should match the final numbering.
- This draft is for manuscript preparation only.
