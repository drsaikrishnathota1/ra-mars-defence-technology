...
![Figure 3. RA-MARS v3 model comparison by macro F1-score.](../figures/graphs/v3/v3_model_comparison_macro_f1.png)

![Figure 4. RA-MARS v3 model comparison by accuracy.](../figures/graphs/v3/v3_model_comparison_accuracy.png)

![Figure 5. RA-MARS v3 per-class F1-score.](../figures/graphs/v3/v3_per_class_f1.png)

![Figure 6. RA-MARS v3 confusion matrix.](../figures/graphs/v3/v3_confusion_matrix.png)

![Figure 7. RA-MARS v3 sequence class distribution.](../figures/graphs/v3/v3_sequence_class_distribution.png)

![Figure 8. RA-MARS v3 ablation study for mission success.](../figures/graphs/v3/v3_ablation_mission_success.png)

![Figure 9. RA-MARS v3 ablation study for Mission Assurance Index.](../figures/graphs/v3/v3_ablation_mission_assurance_index.png)

![Figure 10. RA-MARS v3 Mission Assurance Index by scenario and attack intensity.](../figures/graphs/v3/v3_mission_assurance_by_scenario.png)
