...
- Figure 3. v3 model comparison by macro F1. Source: `figures/graphs/v3/v3_model_comparison_macro_f1.png`
- Figure 4. v3 model comparison by accuracy. Source: `figures/graphs/v3/v3_model_comparison_accuracy.png`
- Figure 5. v3 per-class F1-score. Source: `figures/graphs/v3/v3_per_class_f1.png`
- Figure 6. v3 confusion matrix. Source: `figures/graphs/v3/v3_confusion_matrix.png`
- Figure 7. v3 sequence class distribution. Source: `figures/graphs/v3/v3_sequence_class_distribution.png`
- Figure 8. v3 ablation mission success. Source: `figures/graphs/v3/v3_ablation_mission_success.png`
- Figure 9. v3 ablation Mission Assurance Index. Source: `figures/graphs/v3/v3_ablation_mission_assurance_index.png`
- Figure 10. v3 mission assurance by scenario. Source: `figures/graphs/v3/v3_mission_assurance_by_scenario.png`
- Figure 11. v3 scalability mission success. Source: `figures/graphs/v3/v3_scalability_mission_success.png`
- Figure 12. v3 attack-intensity stress test. Source: `figures/graphs/v3/v3_attack_intensity_stress_test.png`
